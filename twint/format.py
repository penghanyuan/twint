...
def Tweet(config, t):
    if config.Format:
        ...
        output = output.replace("{user_location}", t.user_location)
        output = output.replace("{user_description}", t.user_description)
        output = output.replace("{user_url}", t.user_url)
        output = output.replace("{user_verified}", t.user_verified)
        output = output.replace("{user_protected}", t.user_protected)
        output = output.replace("{name}", t.name)
        output = output.replace("{place_type}", t.place_type)
        output = output.replace("{place_name}", t.place_name)
        output = output.replace("{place_full_name}", t.place_full_name)
        output = output.replace("{place_country_code}", t.place_country_code)
        output = output.replace("{place_country}", t.place_country)
        output = output.replace("{place_bounding_box}", t.place_bounding_box)
        output = output.replace("{coordinates}", t.coordinates)
        output = output.replace("{geocode}", t.geocode)
        ...
        output = output.replace("{quoteds}", t.quote_count)
